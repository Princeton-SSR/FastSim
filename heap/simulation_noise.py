...
def log_meta(fn):
    ...
    """
    meta = {'Experiment': experiment_file, 'Number of fishes': no_fish, 'Number of leaders': no_leader, 'Number of trials': no_trial, 'Simulation time [s]': simulation_time, 'Clock frequency [Hz]': clock_freq, 'Arena [mm]': arena_list, 'Visual range [mm]': v_range, 'Width of blindspot [mm]': w_blindspot, 'Radius of blocking sphere [mm]': r_sphere, 'Visual noise magnitude on leds [% of distance]': n_magnitude_leds, 'Visual noise magnitude on rel_pos [% of distance]': n_magnitude_pos}
