...
w_blindspot_arr = np.linspace(1550, 3141, 20)
influence_param_arr = np.linspace(.2, 1.5, 20)
...
for w_blindspot in w_blindspot_arr:
    for influence_param in influence_param_arr:
       ...
       # filename = time.strftime("%y%m%d_%H%M%S") # date_time
        filename = "bs_eq_{}".format(w_blindspot) + "inf_eq_{}".format(influence_param)
